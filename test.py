...
driver = webdriver.Chrome("/Users/richard/chromedriver")
...
try:
    ...
    Wait(driver, 10).until(EC.presence_of_element_located((By.XPATH, "//*[@id='contentarea']/div/div[1]/label")))
    if not driver.find_element(By.XPATH, "//*[@id='contentarea']/div/div[1]/label").get_attribute("innerHTML") == "Dashboard":
        f.write("   Test Step " + str(step) + " = " + "FAIL\n")
        step = None
        raise Exception()
    f.write("   Test Step " + str(step) + " = " + "PASS\n")
